...
//   await fse.writeJSON(join(public, '/list.json'), examples);

//   // Generate 'download/*.tar.gz'
//   await fse.ensureDir(join(public, '/download'));
//   await generateDownloads(__dirname, examples, join(public, '/download'));

//   // Copy `manifest.json`
//   const target = join(__dirname, 'public/manifest.json');
//   await fse.copy(join(__dirname, 'manifest.json'), target);
// }
